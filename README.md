...
- Setup rails project with webpack
- Use react inside rails app
...
```
git clone https://github.com/biruk-bereka/hello-react-with-rails-app.git
```
...
To run the project, if you are on the hello-react-with-rails folder path on your terminal you can execute the following command:
...
Feel free to check the [issues page](https://github.com/biruk-bereka/hello-react-with-rails/issues).
...
- **What is this project main purpose?**
  ...
  - To learn Ruby on Rails with React using Webpack
